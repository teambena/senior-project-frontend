                    ...
                    <div class="col comp-grid" >
                        <q-card  :flat="isSubPage" class="q-mb-sm q-pa-sm nice-shadow-18">
                            <div class="q-pa-sm" >
                                ...
                                :show-header="true"
                                view-event-page-type="drawer"
                                add-event-page-type="drawer"
                                title-field="appointment_customer"
                                start-date-field="appointment_start_date"
                                start-time-field="appointment_start_time"
                                end-date-field="appointment_end_date"
                                end-time-field="appointment_end_time"
                                :view-change="true"
                                :date-controls="true"
                                :max-days="14"
                                :mini-mode="false"
