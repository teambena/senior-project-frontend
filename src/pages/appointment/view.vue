                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Appointment Details</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <template v-if="!loading && item">
                                        <div class="row q-col-gutter-x-md">
                                            <div class="col">
                                                <q-item>
                                                    <q-item-section>
                                                        <q-item-label caption>Appointment Id: </q-item-label>
                                                        <q-item-label class="text-bold">{{ item.appointment_id }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                ...
                                                <q-item>
                                                    <q-item-section>
                                                        ...
                                                        <q-item-label class="text-bold">{{ item.customer }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                    <q-item-section>
                                                        ...
                                                        <q-item-label class="text-bold">{{ item.start_date }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                    <q-item-section>
                                                        ...
                                                        <q-item-label class="text-bold">{{ item.start_time }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                    <q-item-section>
                                                        ...
                                                        <q-item-label class="text-bold">{{ item.end_date }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                    <q-item-section>
                                                        ...
                                                        <q-item-label class="text-bold">{{ item.end_time }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                    ...
                                                    <q-btn icon="menu" padding="xs" round flat color="grey">
                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                            <q-list dense rounded nav>
                                                                <q-item link clickable v-ripple :to="`/appointment/edit/${item.appointment_id}`">
                                                                    <q-item-section>
                                                                        <q-icon color="positive"  size="sm" name="edit"></q-icon>
                                                                    </q-item-section>
                                                                    <q-item-section>Edit</q-item-section>
                                                                </q-item>
                                                                <q-item link clickable v-ripple @click="deleteItem(item.appointment_id)">
                                                                    <q-item-section>
...
<script>
	...
	export default {
		...
		methods: {
			...mapActions("appointment", [ "fetchRecord", "deleteRecord"]),
		},
		watch: {
			$route (to, from){
