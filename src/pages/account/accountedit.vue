                                                ...
                                                <div class="row q-col-gutter-x-md">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9 col-12">
                                                                <ValidationProvider :rules="{}" name="Credit" v-slot="{ errors, invalid, validated }">
                                                                    <q-input outlined dense  ref="ctrlcredit" v-model.trim="formData.credit"  label="Credit" type="number" placeholder="Enter Credit"   step="any"    
                                                                    class="" :error="invalid && validated" :error-message="errors[0]">
                                                                    </q-input>
                                                                </ValidationProvider>
                                                            </div>
...
<script>
	...
	export default {
		...
		data() {
            return {
				formData: {
					name: "", username: "", business_name: "", business_phone_number: "", business_address: "", credit: "", 
				},
        	}
		},
		computed: {
		...
		methods: {
			...mapActions('manager', ['updateRecord', 'fetchRecord']),
			...
			resetForm (){
				...
				this.formData = {name: "", username: "", business_name: "", business_phone_number: "", business_address: "", credit: "", };
